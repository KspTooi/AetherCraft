...
public enum AIModelEnum {
    ...
    /*正式模型*/
    GEMINI_2_5_FLASH_PREVIEW_0520("gemini-2.5-flash-preview-05-20", "Gemini 2.5 Flash Preview 2025-05-20", "Gemini", "大型", "快速", "精英", 1),
    ...
    GROK_3("grok-3", "Grok-3", "Grok", "大型", "快速", "精英", 0),
    ...
    GROK_3_BETA("grok-3-beta", "Grok 3 Beta", "Grok", "大型", "快速", "精英", 0),
    ...
    GROK_3_MINI_FAST_BETA("grok-3-mini-fast-beta", "Grok 3 Mini Fast Beta", "Grok", "中型", "极速", "铂金", 1),
    ...
    //目前不会计划支持DeepSeek
    DEEPSEEK_CHAT("deepseek-chat", "DeepSeek", "DeepSeek","大型","最慢","白银",0),
    DEEPSEEK_REASONER("deepseek-reasoner", "DeepSeek-Reasoner(R1)", "DeepSeek","大型","最慢","铂金",1),
